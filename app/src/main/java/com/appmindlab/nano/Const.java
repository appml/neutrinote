...
public class Const {
    ...
    protected final static int MIRROR_SHORT_DELAY = 5;        // In minutes
    protected final static int MIRROR_MEDIUM_DELAY = 30;      // In minutes
    protected final static int MIRROR_LONG_DELAY = 60;        // In minutes
